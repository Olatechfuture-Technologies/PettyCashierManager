...
<style>
    body {
        background-image: url('/frontend/images/vector-wallpaper12.jpg');
...
<div class="loginbox">
    <div class="row">
        <div class="login-right-wrap py-3">
            ...
            <p class="account-subtitle text-white text-bold py-2">Staff Dashboard Login Access</p>
            <div class="container">
                <form method="POST" action="{{ route('staff.login-attempt') }}">
                    ...
                    <div class="text-center dont-have">Don't have an account yet? <a href="register">Staff Register</a></div>
                </form>
            </div>
        </div>
    </div>
