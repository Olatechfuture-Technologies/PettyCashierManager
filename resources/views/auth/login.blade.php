...
<div class="loginbox">
    <div class="row">
        <div class="login-right-wrap py-3">
            ...
            <p class="account-subtitle sitebg2 text-white text-bold py-2">Residents Dashboard Login Access</p>
            ...
            <div class="container-fluid">
                <form method="POST" action="{{ route('residents.login-attempt') }}">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-6 text-end">
                                ...
                                <a class="forgot-link" href="{{ route('residents.forget-password') }}">Forgot Password ?</a>
                    ...
                    <div class="text-center dont-have">Don't have an account yet? <a href="{{ route('residents.register-form') }}">Sign Up</a></div>
                </form>
            </div>
        </div>
    </div>
