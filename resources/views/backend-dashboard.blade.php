        ...
        <div class="card flex-fill">
            <div class="card-header">
                <div class="d-flex justify-content-between align-items-center">
                    <h5 class="card-title">Cash Flow Analytics</h5>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center justify-content-between flex-wrap flex-md-nowrap">
                    <div class="w-md-100 d-flex align-items-center mb-3 flex-wrap flex-md-nowrap">
                        <div>
                            <span>Total Service Collected</span>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-center">
                    ...
                    <div class="col-auto">
                        <a href="invoices" class="btn-right btn btn-sm btn-outline-primary">
                            View All
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table table-stripped table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('assets/img/profiles/avatar-04.jpg') }}" alt="User Image">Barbara Moore</a>
                                    </h2>
                                </td>
                                <td>$118</td>
                                <td>23 Nov 2020</td>
                                ...
                                <td class="text-right">
                                    <div class="dropdown dropdown-action">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            ...
                                            <a class="dropdown-item" href="invoice-details"><i class="far fa-eye me-2"></i>View</a>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('assets/img/profiles/avatar-06.jpg') }}" alt="User Image">Karlene Chaidez</a>
                                    </h2>
                                </td>
                                <td>$222</td>
                                <td>18 Nov 2020</td>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('assets/img/profiles/avatar-08.jpg') }}" alt="User Image">Russell Copeland</a>
                                    </h2>
                                </td>
                                <td>$347</td>
                                <td>10 Nov 2020</td>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('assets/img/profiles/avatar-10.jpg') }}" alt="User Image">Joseph Collins</a>
                                    </h2>
                                </td>
                                <td>$826</td>
                                <td>25 Sep 2020</td>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('assets/img/profiles/avatar-11.jpg') }}" alt="User Image">Jennifer Floyd</a>
                                    </h2>
                                </td>
                                <td>$519</td>
                                <td>18 Sep 2020</td>
        ...
        <div class="card">
            <div class="card-header">
                <div class="row align-center">
                    ...
                    <div class="col-auto">
                        <a href="invoice-details" class="btn-right btn btn-sm btn-outline-primary">
                            View All
                        </a>
                    </div>
                </div>
                    ...
                    <table class="table table-hover">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('assets/img/profiles/avatar-05.jpg') }}" alt="User Image"> Greg Lynch</a>
                                    </h2>
                                </td>
                                <td>5 Nov 2020</td>
                                <td>$175</td>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('assets/img/profiles/avatar-07.jpg') }}" alt="User Image"> John Blair</a>
                                    </h2>
                                </td>
                                <td>17 Oct 2020</td>
                                <td>$2350</td>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="profile"><img class="avatar avatar-sm me-2 avatar-img rounded-circle" src="{{ asset('assets/img/profiles/avatar-09.jpg') }}" alt="User Image"> Leatha Bailey</a>
                                    </h2>
                                </td>
                                <td>30 Sep 2020</td>
                                <td>$785</td>
