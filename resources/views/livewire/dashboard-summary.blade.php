            ...
            <div class="card-body">
                <div class="dash-widget-header">
                    ...
                    <div class="dash-count">
                        <div class="dash-title">Resident Wallet Balance</div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="dash-widget-header">
                    ...
                    <div class="dash-count">
                        <div class="dash-title">Residents</div>
                        <div class="dash-counts">
                            <p>3,642</p>
                        </div>
                    </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="dash-widget-header">
                        ...
                        <div class="dash-count">
                            <div class="dash-title">Flats Wallet</div>
                            <div class="dash-counts">
                                <p>1,642</p>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="dash-widget-header">
                        ...
                        <div class="dash-count">
                            <div class="dash-title">Staff on Duty</div>
                            <div class="dash-counts">
                                <p>2</p>
                            </div>
                        </div>
