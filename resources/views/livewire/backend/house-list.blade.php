         ...
         <ul class="filter-list">
             ...
             <li>
                 <a class="btn btn-import" href="javascript:void(0);"><span><i
                             class="fe fe-check-square me-2"></i>Import House List</span></a>
             </li>
             <li>
                 <a class="btn btn-primary" href="add-customer.html"><i class="fa fa-plus-circle me-2"
                         aria-hidden="true"></i>Add House</a>
             </li>
         </ul>
     </x-slot:headerContent>
 </x-slot:header>
                             ...
                             <thead class="thead-light">
                                 <tr role="row">
                                     ...
                                     <th class="sorting" aria-controls="DataTables_Table_0" rowspan="1"
                                         colspan="1" aria-label="House No:">House Adddress</th>
                                     <th class="sorting" aria-controls="DataTables_Table_0" rowspan="1"
                                         colspan="1" aria-label="Name:">House Name</th>

                                     <th class="sorting" aria-controls="DataTables_Table_0" rowspan="1"
                                         colspan="1" aria-label="Number Of Flats:">N0 of Flats </th>
                                     <th class="sorting" aria-controls="DataTables_Table_0" rowspan="1"
                                         colspan="1" aria-label="Number Of Residents:">N0 of Residents </th>
                                     <th class="sorting" aria-controls="DataTables_Table_0" rowspan="1"
                                         colspan="1" aria-label="Created:">Wallet Balance</th>
                                     <th class="sorting" aria-controls="DataTables_Table_0" rowspan="1"
                                         colspan="1" aria-label="ExpensesIncured:">Expenses Incured</th>
                                     <th class="sorting" aria-controls="DataTables_Table_0" rowspan="1"
