             ...
             <div class="dropdown-menu menu-drop-user">
                 <div class="profilemenu">
                     <div class="subscription-menu">
                         <ul>
                             <li>
                                 <a class="dropdown-item" href="templates/profile">Profile</a>
                             </li>
                             <li>
                                 <a class="dropdown-item" href="templates/settings">Settings</a>
                             </li>
                         </ul>
                     </div>
                         ...
                         <ul>
                             <li class="pb-0">
                                 @auth('admin')
                                     ...
                                     <form id="logout-form" action="{{ route('admin.signout') }}" method="POST"
                                         class="d-none">
                                         @csrf
                                     </form>
                                 @endauth
                                 @auth('staff')
                                     <a class="dropdown-item" href="{{ route('staff.signout') }}"
                                         onclick="event.preventDefault(); document.getElementById('logout-form').submit();">
                                         {{ __('Logout') }}
                                     </a>
                                     <form id="logout-form" action="{{ route('staff.signout') }}" method="POST"
                                         class="d-none">
                                         @csrf
                                     </form>
                                 @endauth
                                 @auth
                                     <a class="dropdown-item" href="{{ route('residents.signout') }}"
                                         onclick="event.preventDefault();
                                                    document.getElementById('logout-form').submit();">
                                         {{ __('Logout') }}
                                     </a>

                                     <form id="logout-form" action="{{ route('residents.signout') }}" method="POST"
                                         class="d-none">
                                         @csrf
                                     </form>
                                 @endauth
